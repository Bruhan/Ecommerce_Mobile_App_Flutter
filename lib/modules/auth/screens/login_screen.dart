                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("It’s great to see you again.", style: AppTextStyles.subtitle),
                      SizedBox(height: AppSpacing.xxl),
                      ...
                      AppTextField(
                        ...
                        validator: (v) {
                          ...
                          final ok = RegExp(r'^((\+91)?[6-9]\d{9}|[^@]+@[^@]+\.[^@]+)$').hasMatch(v.trim());
                      ...
                      OutlinedButton(
                        ...
                        child: Text('Login with Google', style: AppTextStyles.body.copyWith(fontWeight: FontWeight.w600)),
                      ),
                      ...
                      OutlinedButton(
                        ...
                        child: Text('Login with Facebook', style: AppTextStyles.body.copyWith(fontWeight: FontWeight.w600)),
                      ),
                      SizedBox(height: AppSpacing.xl),
                      Center(
                        child: Wrap(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Text(
                                'Join',
                                style: AppTextStyles.body.copyWith(decoration: TextDecoration.underline, fontWeight: FontWeight.w600),
                              ),
                            ),
                          ],
                        ),
