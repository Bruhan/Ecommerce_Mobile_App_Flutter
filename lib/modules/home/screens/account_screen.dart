...
class _AccountScreenState extends State<AccountScreen> {
  ...
  /// Try to read a value from the returned map using common key names.
  ...
  // Reusable list row widget with subtle styling
  Widget _row({
  ...
  Widget build(BuildContext context) {
    // Slight elevation card with padding to mimic Figma
    return Scaffold(
      appBar: AppBar(
