              ...
              children: [
                      ...
                      return _CartTile(
                        ...
                        onDecrement: () {
                          if (item.quantity > 1) {
                            ...
                            // Optionally confirm deletion if quantity would go to 0
                            CartManager.instance.removeItem(item.id, size: item.size);
                          }
                        },
                      );
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      // Safe behavior: if you have a checkout route add it to Routes and replace this.
                      // Using SnackBar so compilation doesn't fail if Routes.checkout is not defined.
                      ScaffoldMessenger.of(context).showSnackBar(
